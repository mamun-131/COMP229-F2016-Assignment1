...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-md-offset-3 col-md-4">
                ...
                <div class="containerDecoration">Address:<br>9 Crescent Place<br>
                                                Toronto,ON M4C5L8<br><br>
                                                Phone:<br>647-447-3215<br><br>
                                                Email: <br>mamun131@gmail.com<br>

                </div>
      </div>
                        <div class="col-md-5 col-md-8">
                <h3>Keep Connected</h3><br>
                <div class="containerDecoration">Face Book:<br><a href="https://www.facebook.com/md.mamunur.rahman" target="_blank"><i class="fa fa-facebook fa-lg"></i> My Facebook</a><br><br>
                                                
                                                Twitter:<br><a href="https://mobile.twitter.com/mamun_131" target="_blank"><i class="fa fa-linkedin fa-lg" ></i> My Twitter</a><br><br>
                                                Linkdin:<br><a href="https://www.linkedin.com/in/md-mamunur-rahman-31a6375?trk=nav_responsive_tab_profile_pic" target="_blank"><i class="fa fa-linkedin fa-lg" ></i> My Linkedin</a><br>
